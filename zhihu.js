  ...
  try {
    ...
    observe({
      ...
      callback(mutations, observer) {
        ...
        const newNode = document.createTextNode("html {overflow: auto !important;}");
        newStyle.appendChild(newNode);
        document.head.appendChild(newStyle);
        console.log("initRemoveSignModal");
        let signFlowModal = document.querySelector("body .signFlowModal");
        if (signFlowModal) {
          signFlowModal.parentElement.parentElement.parentElement.remove();
        }

        function initRemoveSignModal() {
          let signFlowModal = document.querySelector("body .signFlowModal");
          if (!remove && signFlowModal) {
            signFlowModal.parentElement.parentElement.parentElement.remove();
            remove = true;
          } else {
            setTimeout(function () {
